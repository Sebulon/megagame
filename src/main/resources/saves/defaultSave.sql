;             
CREATE USER IF NOT EXISTS "SA" SALT '15fb90a09b046a50' HASH 'f6ac7742560850b63e563cfe8e4b254ff6cb203c2f200876bc768665e0a365e8' ADMIN;         
...
('High Charity', 10, 0, 'The Covenant', 10, 'TestTeam1'),
('Unyielding Hierophant', 40, 0, 'The Covenant', 40, 'TestTeam2');      
...
ALTER TABLE "PUBLIC"."TEST_SHIP" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_6" PRIMARY KEY("NAME");  
