;             
CREATE USER IF NOT EXISTS "SA" SALT '75194e77eb4387bd' HASH '04e85be01c26eed70fae17f5035ba024c97536eda1934d6db53eabad903ad7aa' ADMIN;         
...
-- 3 +/- SELECT COUNT(*) FROM PUBLIC.CELESTIAL_BODY;          
INSERT INTO "PUBLIC"."CELESTIAL_BODY" VALUES
('Star', 'Yellow Star 1', 2, 'Yellow Star', NULL, NULL, NULL, NULL),
('Planetoid', 'Frozen Planet 2', 3, 'Frozen Planet', NULL, X'aced0005737200116a6176612e7574696c2e486173684d61700507dac1c31660d103000246000a6c6f6164466163746f724900097468726573686f6c6478703f400000000000007708000000100000000078', 0, X'aced0005737200136a6176612e7574696c2e41727261794c6973747881d21d99c7619d03000149000473697a6578700000000077040000000078'),
('Planetoid', 'Habitable Planet 3', 2, 'Habitable Planet', NULL, X'aced0005737200116a6176612e7574696c2e486173684d61700507dac1c31660d103000246000a6c6f6164466163746f724900097468726573686f6c6478703f400000000000007708000000100000000078', 0, X'aced0005737200136a6176612e7574696c2e41727261794c6973747881d21d99c7619d03000149000473697a6578700000000077040000000078');  
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.GATHER_MINIGAME;         
INSERT INTO "PUBLIC"."GATHER_MINIGAME" VALUES
('High Charity', 'Frozen Planet 2'),
('Unyielding Hierophant', 'Habitable Planet 3');         
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.GATHER_MINIGAME_BASE_EXTRACTION_RATE;    
INSERT INTO "PUBLIC"."GATHER_MINIGAME_BASE_EXTRACTION_RATE" VALUES
('High Charity', 5, 'RAW MATERIALS'),
('Unyielding Hierophant', 3, 'WATER');             
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.GATHER_MINIGAME_MINIMUM_CREW;            
INSERT INTO "PUBLIC"."GATHER_MINIGAME_MINIMUM_CREW" VALUES
('High Charity', 2, 'RAW MATERIALS'),
('Unyielding Hierophant', 1, 'WATER');     
...
('First session', 1, 'Solar system 0');              
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.SOLAR_SYSTEM;            
INSERT INTO "PUBLIC"."SOLAR_SYSTEM" VALUES
('Solar system 0', 3);            
CREATE CACHED TABLE "PUBLIC"."SOLAR_SYSTEM_OBJECTS"(
    "SOLAR_SYSTEM_NAME" VARCHAR(255) NOT NULL,
    "OBJECTS_NAME" VARCHAR(255) NOT NULL
);            
-- 3 +/- SELECT COUNT(*) FROM PUBLIC.SOLAR_SYSTEM_OBJECTS;    
INSERT INTO "PUBLIC"."SOLAR_SYSTEM_OBJECTS" VALUES
('Solar system 0', 'Yellow Star 1'),
('Solar system 0', 'Frozen Planet 2'),
('Solar system 0', 'Habitable Planet 3');   
